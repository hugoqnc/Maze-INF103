...
public class Maze implements GraphInterface
	...
	private static ArrayList<String> caractere(){//liste des caractÃ¨res acceptes
...
*/
	...
	public int getWeight(VertexInterface src,VertexInterface dst) {// Ã  modifier si graph pondÃ©rÃ©.
		Box boxSrc = (Box)src ;
		Box boxDst = (Box)dst ;
		return 1;
	}
